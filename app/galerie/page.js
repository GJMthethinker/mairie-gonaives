  ...
  return (
    <div className="min-h-screen bg-[var(--cream)] text-[var(--ink)]">
      ...
      <main className="max-w-5xl mx-auto px-6 py-14">
        <h1 className="font-display text-3xl text-[#034E28] mb-2">La Mairie en action</h1>
        <p className="text-sm text-[var(--ink-muted)] mb-8">Toutes les photos publiées par la mairie.</p>
      ...
      {lightbox && (
        <div className="lightbox-overlay" onClick={() => setLightbox(null)}>
          <div className="lightbox-content" onClick={(e) => e.stopPropagation()}>
            ...
            <p className="text-center text-[#F5E600] text-sm mt-3">
              {lightbox.caption} {lightbox.caption && "·"} {frDate(lightbox.published_at)}
            </p>
          </div>
